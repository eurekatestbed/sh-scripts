CREATE TABLE prices(TDATE,NAME,REMARKS,CURRENCY,HIGH,LOW,LAST,CHANGE,VOLUME,BID,OFFER,MARKET,OPEN,VALUE,CODE not null,DClose,extra, primary key(CODE,TDate));
